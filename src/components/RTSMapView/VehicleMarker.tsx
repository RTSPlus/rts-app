        ...
        {props.direction && (
          <View
            style={[
              ...
              isInbound
                ? {
                    backgroundColor: colors.ios.light.cyan.toRgbString(),
                    borderColor: colors.ios.light.blue.toRgbString(),
                  }
                : {
                    backgroundColor: colors.ios.light.orange.toRgbString(),
                    borderColor: colors.ios.light.red.toRgbString(),
                  },
            ]}
          >
            <Text
