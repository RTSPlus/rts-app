  ...
  const getDirections = async () => {
    try {
      const response = await fetch(
        `https://maps.googleapis.com/maps/api/directions/json?origin=${originAddress}&destination=${destinationAddress}&mode=transit&transit_mode=bus&key=${RTS_GOOGLE_API_KEY}`
      );
